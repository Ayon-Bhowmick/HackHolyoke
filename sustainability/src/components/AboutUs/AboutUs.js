          ...
          <div class="container">
            <div class="row align-items-center my-5">
              ...
              <div class="col-lg-5">
                ...
                <p class="mission">
                  With this webApp mission with SusFood is to provide an easy way for an individual to keep track of their perishable food items. We hope this app can help eliminate food waste as well as costs for every user. 
                </p>
              </div>
              <div class="col-lg-7">
